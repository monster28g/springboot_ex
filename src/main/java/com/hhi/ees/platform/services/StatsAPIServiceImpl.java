...
public class StatsAPIServiceImpl implements StatsAPIService {
    ...
    public Object execute(String query, HttpMethod httpMethod) {
        try {
            ...
            return restTemplate.execute(new URI(query), httpMethod, null, new StatsAPIServiceImpl.ApiCallResponseExtractor(Object.class, restTemplate.getMessageConverters()));
