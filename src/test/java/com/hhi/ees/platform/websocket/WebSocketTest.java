...
@TestPropertySource(
//        locations = {"properties/gateway.properties", "properties/db.properties", "properties/push_service.properties"},
        properties = {"push.service.duration=10"}
)
public class WebSocketTest {
//    @Autowired private PushServiceInfo pushServiceInfo;
//    @Autowired private SimpleGatewayService simpleGatewayService;
